        ...
        <div class="list_user">
            ...
            <table class="table table-bordered" >
                ...
                <tr>
                    ...
                    <td>
                        <form action="/doc-gia/delete/{{$dg -> id}}" method="post" onsubmit="return ConfirmDelete( this )">
                            @method('DELETE')
                            @csrf
                            <section class="btn-delete_user">
                                <button type="submit">
                                    Xóa
                                </button>
                            </section>
    ...
    <div class="edit_user">
        <form action="">
            ...
            <div class="_card--form">
                ...
                <div class="input-contact">
                    <label>
                        <input type="text" name="diachi" placeholder="IT18">
                        <section>
                            Lớp
                        </section>
                    </label>
